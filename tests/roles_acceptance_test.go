...
func TestCreateRole(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "success: create a new role",
			args: args{
				query: map[string]interface{}{
					"query": graphqlMutation,
					"variables": map[string]interface{}{
						"input": map[string]interface{}{
							"name":        "Acceptance Test Role",
							"description": "Role creation Test",
							"scopes":      []string{"agent.view"},
						},
					},
				},
			},
		...
		{
			name: "fail:cannot create a new role with similar name",
			args: args{
				query: map[string]interface{}{
					"query": graphqlMutation,
					"variables": map[string]interface{}{
						"input": map[string]interface{}{
							"name":        testRoleName, // this role name exists and is used to run tests
							"description": "Role creation Test",
							"scopes":      []string{"agent.view"},
						},
					},
...
func TestAddPermissionsToRole(t *testing.T) {
	...
	// get role id using repository
	role, err := getRoleByName(t, testRoleName)
	if err != nil {
	...
	graphqlMutation := `
	mutation addPermission($input: RolePermissionInput!) {
	...
	tests := []struct {
		...
		{
			name: "success: add permission to role",
			args: args{
				query: map[string]interface{}{
					"query": graphqlMutation,
					"variables": map[string]interface{}{
...
func TestAssignRole(t *testing.T) {
	...
	creds, err := getTestUserCredentials(t)
	if err != nil {
		t.Errorf("cannot get logged in user credentials")
		return
	}

	role, err := CreateTestRole(t, "Test Assign Role")
	if err != nil {
		t.Errorf("cannot create a test role")
		return
	}
...
func TestRevokeRole(t *testing.T) {
	...
	role, err := CreateTestRole(t, "Test Revoke Role")
	if err != nil {
		t.Errorf("cannot create a test role")
		return
	}

	_, err = AssignTestRole(t, creds.Profile.ID, role.ID)
	if err != nil {
		t.Errorf("cannot assign a test revoke role")
		return
	}
