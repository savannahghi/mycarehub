...
// ChargeMasterUseCasesImpl ..
type ChargeMasterUseCasesImpl struct {
	ChargeMasterClient *base.ServerClient
}

// NewChargeMasterUseCasesImpl ...
func NewChargeMasterUseCasesImpl(r repository.OnboardingRepository) ChargeMasterUseCases {
	...
	return &ChargeMasterUseCasesImpl{ChargeMasterClient: client}
}

// FetchChargeMasterClient ...
func (chr ChargeMasterUseCasesImpl) FetchChargeMasterClient() *base.ServerClient {
...
func (chr ChargeMasterUseCasesImpl) FindProvider(ctx context.Context, pagination *base.PaginationInput,
...
func (chr ChargeMasterUseCasesImpl) FindBranch(ctx context.Context, pagination *base.PaginationInput,
