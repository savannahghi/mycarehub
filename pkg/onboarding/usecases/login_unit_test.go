...
// 	libDTO "github.com/savannahghi/onboarding/pkg/onboarding/application/dto"
...
// 				fakeBaseExt.GetLoggedInUserFn = func(ctx context.Context) (*libDTO.UserInfo, error) {
// 					return &libDTO.UserInfo{
...
// 				fakeRepo.GetPINByProfileIDFn = func(ctx context.Context, profileID string) (*libDomain.PIN, error) {
// 					return &libDomain.PIN{ID: "123", ProfileID: "456"}, nil
// 				}
// 				fakePinExt.ComparePINFn = func(rawPwd string, salt string, encodedPwd string, options *libExtension.Options) bool {
// 					return true
// 				}
...
// 				}
// 				fakeRepo.GetUserProfileByUIDFn = func(ctx context.Context, uid string, suspended bool) (*profileutils.UserProfile, error) {
// 					return nil, fmt.Errorf("could not get user profile")
// 				}
