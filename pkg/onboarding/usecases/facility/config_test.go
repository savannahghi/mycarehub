...
import (
	...
	facilityMock "github.com/savannahghi/onboarding-service/pkg/onboarding/usecases/facility/mock"
)
...
var (
	...
	fakeCreate facilityMock.CreateMock
	fakeQuery  facilityMock.QueryMock
)
