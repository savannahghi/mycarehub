...
func (f *FakeOnboardingRepository) GetSupplierProfileByID(ctx context.Context, id string) (*profileutils.Supplier, error) {
...
func (f *FakeOnboardingRepository) GetSupplierProfileByUID(ctx context.Context, uid string) (*profileutils.Supplier, error) {
	return f.GetSupplierProfileByUIDFn(ctx, uid)
}

// GetSupplierProfileByProfileID ...
func (f *FakeOnboardingRepository) GetSupplierProfileByProfileID(ctx context.Context, profileID string) (*profileutils.Supplier, error) {
	return f.GetSupplierProfileByProfileIDFn(ctx, profileID)
}

// AddPartnerType ...
func (f *FakeOnboardingRepository) AddPartnerType(ctx context.Context, profileID string, name *string, partnerType *profileutils.PartnerType) (bool, error) {
	return f.AddPartnerTypeFn(ctx, profileID, name, partnerType)
}

// UpdateSupplierProfile ...
func (f *FakeOnboardingRepository) UpdateSupplierProfile(ctx context.Context, profileID string, data *profileutils.Supplier) error {
...
func (f *FakeOnboardingRepository) AddSupplierAccountType(ctx context.Context, profileID string, accountType profileutils.AccountType) (*profileutils.Supplier, error) {
...
func (f *FakeOnboardingRepository) ActivateSupplierProfile(ctx context.Context, profileID string, supplier profileutils.Supplier) (*profileutils.Supplier, error) {
...
// SetUpSupplier ...
func (f *FakeOnboardingRepository) SetUpSupplier(ctx context.Context, accountType profileutils.AccountType) (*profileutils.Supplier, error) {
...
func (f *FakeOnboardingRepository) GetCustomerProfileByID(ctx context.Context, id string) (*profileutils.Customer, error) {
	return f.GetCustomerProfileByIDFn(ctx, id)
}

// GetCustomerProfileByProfileID ...
func (f *FakeOnboardingRepository) GetCustomerProfileByProfileID(ctx context.Context, profileID string) (*profileutils.Customer, error) {
...
func (f *FakeOnboardingRepository) CreateEmptySupplierProfile(ctx context.Context, profileID string) (*profileutils.Supplier, error) {
	return f.CreateEmptySupplierProfileFn(ctx, profileID)
}

// CreateEmptyCustomerProfile creates an empty customer profile
func (f *FakeOnboardingRepository) CreateEmptyCustomerProfile(ctx context.Context, profileID string) (*profileutils.Customer, error) {
...
func (f *FakeOnboardingRepository) GetCustomerOrSupplierProfileByProfileID(ctx context.Context, flavour feedlib.Flavour, profileID string) (*profileutils.Customer, *profileutils.Supplier, error) {
...
// GetNavActions ...
func (f *FakeOnboardingRepository) GetNavActions(ctx context.Context, role profileutils.RoleType) (*profileutils.NavigationActions, error) {
...
func (f *FakeOnboardingRepository) CreateDetailedSupplierProfile(ctx context.Context, profileID string, supplier profileutils.Supplier) (*profileutils.Supplier, error) {
...
func (f *FakeOnboardingRepository) SaveCoverAutolinkingEvents(ctx context.Context, input *dto.CoverLinkingEvent) (*dto.CoverLinkingEvent, error) {
