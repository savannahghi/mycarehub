...
// AgentApprovalEmail is the email sent to an agent once registered
const AgentApprovalEmail = `
<!DOCTYPE html>
...
<head>
  ...
  <meta property="description" content="Agent has been approved.">
  <!--VIEWPORT-->
...
<body width="100%" style="margin: 0; padding: 0 !important; background-color: #f1f1f1;">
              ...
              <tr>
                <td>
                  <div class="text" style="padding: 0 3em;">
                    <p style="margin-bottom: 14px">Hello {{.Name}},</p>
                    <p style="margin: 0">
                    ...
                    <p></p>
                    <p style="margin: 0">
                      Please use this One Time PIN(OTP): {{.Pin}} and your phone number to login to your Be.Well
                    ...
                    <tr>
                      <td style="text-align: left; padding-left: 10px;">
                        ...
                        <ul>
                          ...
                          <li><a href="https://www.instagram.com/BeWellBySlade360/">Instagram</a>
                          </li>
                          <li><a href="https://www.linkedin.com/showcase/be-well-by-slade-360">Linkedin</a>
                        </ul>
                      </td>
                    </tr>
                  </table>
                      ...
                      <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                        ...
                        <ul>
                          ...
                          <li><span class="text"><a href="tel:+254 790 360 360">+254 790 360
                                360</span></a></li>
                          <li><span class="text"><a href="mailto:feedback@bewell.co.ke">feedback@bewell.co.ke</span></a>
                          </li>
                        </ul>
                      </td>
                    </tr>
  ...
  <script>
    ...
    analytics.logEvent('opened_agent_approval_email');
  </script>
</body>
