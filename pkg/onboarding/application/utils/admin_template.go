...
// AdminApprovalEmail is the email sent to an admin once registered
...
<head>
    ...
    <meta property="description" content="Service provider admin approval.">
    <!--VIEWPORT-->
...
<body width="100%" style="margin: 0; padding: 0 !important; background-color: #f1f1f1;">
                            ...
                            <tr>
                                <td>
                                    <div class="text" style="padding: 0 3em;">
                                        <p style="margin-bottom: 16">Hello {{.Name}},</p>

                                        <p style="margin: 0">
                                            You have been successfully registered as an admin. We look
                                            forward to working with you.
                                        </p>
                                        <p style="margin: 0">
                                            Please use this One Time PIN(OTP): {{.Pin}} and your phone number to login
                                            to your Be.Well Professional account.
                                        </p>
    ...
    <script>
        ...
        analytics.logEvent('opened_admin_approval_email');
    </script>
</body>
