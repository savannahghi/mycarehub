...
func TestBookingState_String(t *testing.T) {
	tests := []struct {
		name string
		e    BookingState
		want string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.e.String(); got != tt.want {
				t.Errorf("BookingState.String() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestBookingState_IsValid(t *testing.T) {
	tests := []struct {
		name string
		e    BookingState
		want bool
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.e.IsValid(); got != tt.want {
				t.Errorf("BookingState.IsValid() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestBookingState_UnmarshalGQL(t *testing.T) {
	value := UpcomingBooking
	invalid := BookingState("invalid")
	type args struct {
		v interface{}
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if err := tt.e.UnmarshalGQL(tt.args.v); (err != nil) != tt.wantErr {
				t.Errorf("BookingState.UnmarshalGQL() error = %v, wantErr %v", err, tt.wantErr)
			}
		})
	}
}

func TestBookingState_MarshalGQL(t *testing.T) {
	w := &bytes.Buffer{}
	tests := []struct {
		name  string
		e     BookingState
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tt.e.MarshalGQL(tt.b)
			if gotW := w.String(); gotW != tt.wantW {
				t.Errorf("BookingState.MarshalGQL() = %v, want %v", gotW, tt.wantW)
			}
		})
	}
}
