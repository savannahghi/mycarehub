...
type PostgresMock struct {
	...
	MockAddCaregiverToClientFn                           func(ctx context.Context, clientCaregiver *domain.CaregiverClients) error
}
...
func (gm *PostgresMock) AddCaregiverToClient(ctx context.Context, clientCaregiver *domain.CaregiverClients) error {
