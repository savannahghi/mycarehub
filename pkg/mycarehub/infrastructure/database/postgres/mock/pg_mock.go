...
type PostgresMock struct {
	...
	MockSearchProgramsFn                                      func(ctx context.Context, searchParameter string, organisationID string, pagination *domain.Pagination) ([]*domain.Program, *domain.Pagination, error)
...
func NewPostgresMock() *PostgresMock {
	...
	return &PostgresMock{
		...
		MockSearchProgramsFn: func(ctx context.Context, searchParameter string, organisationID string, pagination *domain.Pagination) ([]*domain.Program, *domain.Pagination, error) {
			return []*domain.Program{program}, &domain.Pagination{Limit: 10, CurrentPage: 1}, nil
		},
		MockCheckClientExistsFn: func(ctx context.Context, userID string) (bool, error) {
			return true, nil
		},
...
func (gm *PostgresMock) GetPendingServiceRequestsCount(ctx context.Context, facilityID string, programID string) (*domain.ServiceRequestsCountResponse, error) {
	return gm.MockGetPendingServiceRequestsCountFn(ctx, facilityID, programID)
}
...
func (gm *PostgresMock) SearchPrograms(ctx context.Context, searchParameter string, organisationID string, pagination *domain.Pagination) ([]*domain.Program, *domain.Pagination, error) {
...
func (gm *PostgresMock) ListBookings(ctx context.Context, clientID string, bookingState enums.BookingState, pagination *domain.Pagination) ([]*domain.Booking, *domain.Pagination, error) {
	return gm.MockListBookingsFn(ctx, clientID, bookingState, pagination)
}
