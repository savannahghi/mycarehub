...
CREATE TABLE IF NOT EXISTS communities_postinghour (
    id uuid NOT NULL PRIMARY KEY,
    active boolean NOT NULL,
    created timestamp WITH time zone NOT NULL,
    created_by uuid,
    ...
    START time NOT NULL,
    "end" time NOT NULL,
    community_id uuid NOT NULL CONSTRAINT communities_postingh_community_id_56c1fb61_fk_communiti REFERENCES communities_community deferrable initially deferred,
    organisation_id uuid NOT NULL CONSTRAINT communities_postingh_organisation_id_761f8f22_fk_common_or REFERENCES common_organisation deferrable initially deferred
);
...
CREATE TABLE IF NOT EXISTS common_userfacilityallotment (
    id uuid NOT NULL PRIMARY KEY,
    active boolean NOT NULL,
    created timestamp WITH time zone NOT NULL,
    created_by uuid,
    updated timestamp WITH time zone NOT NULL,
    updated_by uuid,
    allotment_type varchar(10) NOT NULL,
    region_type varchar(20),
    counties varchar(150) [],
    constituencies varchar(150) [],
    sub_counties varchar(150) [],
    wards varchar(150) [],
    organisation_id uuid NOT NULL CONSTRAINT common_userfacilitya_organisation_id_e7fbb19c_fk_common_or REFERENCES common_organisation deferrable initially deferred,
    user_id uuid NOT NULL UNIQUE CONSTRAINT common_userfacilityallotment_user_id_a8a6acde_fk_users_user_id REFERENCES users_user deferrable initially deferred,
    deleted_at timestamp WITH time zone
);

CREATE TABLE IF NOT EXISTS common_userfacilityallotment_facilities (
    id serial PRIMARY KEY,
    userfacilityallotment_id uuid NOT NULL CONSTRAINT common_userfacilitya_userfacilityallotmen_7de33692_fk_common_us REFERENCES common_userfacilityallotment deferrable initially deferred,
    facility_id uuid NOT NULL CONSTRAINT common_userfacilitya_facility_id_d3802dfb_fk_common_fa REFERENCES common_facility deferrable initially deferred,
    CONSTRAINT common_userfacilityallot_userfacilityallotment_id_75dfb0d0_uniq UNIQUE (userfacilityallotment_id, facility_id)
);
