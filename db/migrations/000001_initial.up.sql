...
CREATE TABLE IF NOT EXISTS "users_user_organisation" (
...
ALTER TABLE
    IF EXISTS "users_user"
    ADD
        CONSTRAINT "users_user_current_organisation_id_fkey" FOREIGN KEY ("current_organisation_id") REFERENCES "common_organisation" ("id");

ALTER TABLE
    IF EXISTS "users_user_organisation"
    ADD
        CONSTRAINT "users_user_organisation_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users_user" ("id");

ALTER TABLE
    IF EXISTS "users_user_organisation"
    ADD
        CONSTRAINT "users_user_organisation_organisation_id_fkey" FOREIGN KEY ("organisation_id") REFERENCES "common_organisation" ("id");
