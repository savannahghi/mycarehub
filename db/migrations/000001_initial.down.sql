...
DROP TABLE IF EXISTS common_userfacilityallotment_facilities;

DROP TABLE IF EXISTS common_userfacilityallotment;
...
DROP TABLE IF EXISTS communities_postinghour;
