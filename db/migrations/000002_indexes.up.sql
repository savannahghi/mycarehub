...
CREATE INDEX IF NOT EXISTS communities_postinghour_community_id_56c1fb61 ON communities_postinghour (community_id);

CREATE INDEX IF NOT EXISTS communities_postinghour_organisation_id_761f8f22 ON communities_postinghour (organisation_id);
...
-- common_userfacilityallotment
CREATE INDEX IF NOT EXISTS common_userfacilityallotment_organisation_id_e7fbb19c ON common_userfacilityallotment (organisation_id);

CREATE INDEX IF NOT EXISTS common_userfacilityallotme_userfacilityallotment_id_7de33692 ON common_userfacilityallotment_facilities (userfacilityallotment_id);

CREATE INDEX IF NOT EXISTS common_userfacilityallotment_facilities_facility_id_d3802dfb ON common_userfacilityallotment_facilities (facility_id);
